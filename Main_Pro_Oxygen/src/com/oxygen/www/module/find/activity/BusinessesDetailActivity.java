...
public class BusinessesDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		web_detail.loadUrl(UrlConstants.BUSINESSES_DETAIL_URL
				+ getIntent().getIntExtra("businesses_id", 0));
	}
