...
public class PostsListAdapter extends BaseAdapter {
	...
	public PostsListAdapter(Context c, List<Posts> postses) {
		this.c = c;
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		holder.tv_created_at.setText(posts.getPublish_time().substring(0, 10));
		...
		ImageUtil.showImage(
					(posts.getPic()+Constants.qiniu_photo_find).trim(), holder.iv_head,R.drawable.nopic);
		Log.i("postview", "holder"+(System.currentTimeMillis()-time1)+"ms");
		return convertView;
	}
