...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	public void setCanPullDown(boolean pullDown) {
		this.canPullDown = pullDown;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			// 通知 FeedFragment 关闭 评论输入框
			EventBus.getDefault().post(new FeedClose(123));
...
//				Log.i("OnScrollListener", "imageloader.resume");
				imageLoader.resume();
				break;
			case OnScrollListener.SCROLL_STATE_TOUCH_SCROLL:
//				Log.i("OnScrollListener", "imageloader.pause");
					imageLoader.pause();
				break;
